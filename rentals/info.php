...
<head>
    ...
    <title>Jansen Rental - Welkom bij Ons</title>
</head>
<body>
    <!-- Hoofdinhoud -->
<div class="container mt-4">
    <h1 class="display-4">Welkom bij Jansen Rental</h1>
    <p class="lead">
    ...
    <ul class="list-group">
        ...
        <li class="list-group-item">Beoordelingen en feedback van andere reizigers om je te helpen bij je keuze.</li>
    </ul>

    <h2>Contactgegevens</h2>
    <p>
        Heb je vragen of heb je hulp nodig bij het plannen van je verblijf? Neem gerust contact met ons op.
    </p>
    <ul class="list-group">
